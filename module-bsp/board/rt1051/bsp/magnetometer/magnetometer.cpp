    ...
    namespace magnetometer
    {
        ...
        bool i2cWrite(const uint8_t reg_addr, const als31300::whole_reg_t whole_reg)
        {
            ...
            if (als31300::EEPROM_REGS.count(reg_addr) == 1) {
                vTaskDelay(pdMS_TO_TICKS(als31300::EEPROM_REG_WRITE_DELAY_MS));
            }
            return wrote;
        }
        ...
        int32_t init(xQueueHandle qHandle)
        {
            ...
            i2cRead(als31300::CONF_REG, read_reg);
            LOG_DEBUG("CONF read 2:\t%" PRIu32, static_cast<uint32_t>(als31300::conf_reg(read_reg)));
            ...
            if (current_reg_int != reg_int) {
                assert(i2cWrite(als31300::INT_REG, reg_conf));
                LOG_DEBUG("INT wrote:\t%" PRIu32, static_cast<uint32_t>(reg_int));
            }
            i2cRead(als31300::INT_REG, read_reg);
            LOG_DEBUG("INT read 2:\t%" PRIu32, static_cast<uint32_t>(als31300::int_reg(read_reg)));
