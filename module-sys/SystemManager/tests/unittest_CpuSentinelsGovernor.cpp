...
namespace sys
{
    class MockedServicee : public sys::Service
    {
      public:
        MockedServicee(const std::string &name) : sys::Service(name)
        {}
...
{
    using namespace sys;
    auto mockedService                          = std::make_shared<MockedServicee>("TestService");
